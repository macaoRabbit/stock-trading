...
public class RandomPairExperimentTest {
    static TradingAlgorithm tradingAlgorithm = TradingAlgorithm.RATIO_SPLIT;
    @Test
    public void randomPairExperimentTest() {
        ...
        FullPairExperiment f = new RandomPairExperiment(tradings, gapRange, powerRange, isLossMajor);
