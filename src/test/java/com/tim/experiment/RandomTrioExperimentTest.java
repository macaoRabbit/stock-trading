...
public class RandomTrioExperimentTest {
    static TradingAlgorithm tradingAlgorithm = TradingAlgorithm.RATIO_SPLIT;
    @Test
    public void randomTrioExperimentTest() {
        ...
        FullPairExperiment f = new RandomTrioExperiment(tradings, gapRange, powerRange, isLossMajor);
